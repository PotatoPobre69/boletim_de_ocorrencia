...
<body>
    <div class="container mt-4">
        ...
        <form action="./boletim.php" method="post">
                ...
                if (isset($tipo_ocorrencia))
                {
                    ...
                    //Informações sobre: Roubo ou Furto de Veículos
                        case '1':
                            ...
                            echo '  <textarea name="relato_boletim" class="form-control" rows="10" placeholder="Escreva Aqui" required></textarea>';
                            echo '</div>';
                        break;
            ...
            ?>
            <a href="./informacoes_delatante.php" class="btn btn-danger">Voltar</a>
